<div class="hero" data-src="{!! $slide['hero_image']['sizes']['large@1x'] !!}">
    ...
    <div class="callout">
        ...
        @if($slide['hero_home_callout_button_button_url'])
        <div class="button-container">
            <a class="button" href="{!! $slide['hero_home_callout_button_button_url']!!}">{!! $slide['hero_home_callout_button_button_text'] !!}</a>
        </div>
        @endif
    </div>
</div>