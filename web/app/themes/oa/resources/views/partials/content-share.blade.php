<div class="share">
  <div class="share-options">
    ...
    <div class="share-channel">
      <a href="https://twitter.com/intent/tweet?text={!! urlencode(App::postTitle()); !!}&url={!! get_the_permalink(); !!}&via={!! App::get_field('twitter_handle', 'option') !!}" class="twitter" onclick="ga('send', 'event', 'social', 'share', 'twitter');" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i><span class="sr-only">{!! _e('Share on twitter','sage'); !!}</span></a>
    </div>
    <div class="share-channel">
